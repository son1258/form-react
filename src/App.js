    ...
    <div className="App">
      ...
      <fieldset>
        <form action="#" method="get">
          ...
          <input type="tel" name="contact" id="contact" value={contact} onChange={(e)=> setContact(e.target.value)} placeholder='Enter your phone number' required />
          ...
          <input type="url" name="url" id="url" onChange={(e) => setUrl(e.target.value)} required />
          
          <label>Select your choice</label>
          <select name="select" id="select" value={selectedOption} onChange={(e) => setSelectedOption(e.target.value)}> 
            <option value="" disabled selected={selectedOption === ""}>Select your answers</option>
